...
#    plt.axis([0,300,-256,+100])
    ...
    plt.show() #TODO: Remove this penalty
    plt.close()
...
#    mean = trail_winnings_array.mean(axis=0)
    ...
    plt.plot(std_dev,marker='', color='salmon', linewidth=2, label='S.D')
    generate_graph('Experiment 1 Standard Deviation', 'exp1_sd.png')
#    plt.show()
...
#    mean = trail_winnings_array.mean(axis=0)
    std_dev = trail_winnings_array.std(axis=0)
    plt.plot(std_dev,marker='', color='green', linewidth=2, label='S.D')
    generate_graph('Experiment 2 Standard Deviation', 'exp2_sd.png')
#    plt.show()
#    # Generate the graph
#    plt.plot(mean,marker='', color='green', linewidth=2, label='Mean')
#    plt.plot(mean+std_dev,marker='', color='orange', linewidth=2, label='Mean + Standard Deviation')
